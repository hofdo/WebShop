...
<section>
    <table>
            ...
            <tr class='productPrice'><td <?php echo "id='productPrice_$product[0]'" ?> ><?php echo $product[3] . " sfr" ?></td></tr>
            <tr class='productDescription'><td><?php echo t($product[1] . "_Description") ?></td></tr>
            <?php
