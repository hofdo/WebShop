...
<div>
    <div class="cart" id="cart">
        ...
        <table id='paymentTable' class="paymentTable">
            ...
            <tr>
                <td>Total:</td>
                <td id='totalProductValue'><?php echo $totalValue . ' CHF' ?></td>
            </tr>
        </table>
        <?php
        if (Product::checkOrderIsOpen()) {
    ...
    <div class="PaymentDetails" id="PaymentDetails">
        ...
        <table>
            <tr>
                <td>
                    <button onclick="closePaymentDetails()">X</button>
                </td>
            </tr>
            <tr>
                <td><?php echo t("gender") ?>:</td>
                <td><select id="paymentDetailsGender">
            ...
            <tr>
                ...
                <td><input id="paymentDetailsFirstName" type="text" value=""></td>
            </tr>
            <tr>
                <td><?php echo t("lastName") ?>:</td>
                <td><input id="paymentDetailsLastName" type="text" value=""></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td><input id="paymentDetailsEmail" type="email" value=""></td>
            </tr>
            <tr>
                <td><?php echo t("address") ?>:</td>
                <td><input id="paymentDetailsAddress" type="text" value=""></td>
            </tr>
            <tr>
                <td>PLZ:</td>
                <td><input id="paymentDetailsPLZ" type="text" value=""></td>
            </tr>
            <tr>
                <td><?php echo t("city") ?>:</td>
                <td><input id="paymentDetailsState" type="text" value=""></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <button type='submit' id="paymentDetailsBtn" class="paymentDetailsBtn"
                            onclick="sendPayment()"><?php echo t("pay"); ?></button>
                </td>
            </tr>
        </table>
    </div>
    <div class="paymentConfirmation" id="paymentConfirmation">
        ...
        <table class="paymentDetailsTable" id="paymentDetailsTable">
            <tr>
                <td><?php echo t("gender") ?>:</td>
                <td id="paymentConfirmationGender"></td>
            </tr>
            <tr>
                <td><?php echo t("firstName") ?>:</td>
                <td id="paymentConfirmationFirstName"></td>
            </tr>
            <tr>
                <td><?php echo t("lastName") ?>:</td>
                <td id="paymentConfirmationLastName"></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td id="paymentConfirmationEmail"></td>
            </tr>
            <tr>
                <td><?php echo t("address") ?>:</td>
                <td id="paymentConfirmationAddress"></td>
            </tr>
            <tr>
                <td>PLZ:</td>
                <td id="paymentConfirmationPLZ"></td>
            </tr>
            <tr>
                <td><?php echo t("city") ?>:</td>
                <td id="paymentConfirmationCity"></td>
            </tr>
            <tr>
                <td><?php echo t("address") ?>country:</td>
                <td id="paymentConfirmationCountry"></td>
            </tr>
            <tr>
                <td><?php echo t("paymentMethod") ?>:</td>
                <td id="paymentConfirmationPaymentMethod"></td>
            </tr>
        </table>
    </div>
    <div class="creditCardDetails" id="creditCardDetails">
        ...
        <table>
            <tr>
                <td><?php echo t("CCHolder") ?>:</td>
                <td id="paymentConfirmationHolderName"></td>
            </tr>
            <tr>
                <td><?php echo t("CCNumber") ?>:</td>
                <td id="paymentConfirmationNumber"></td>
            </tr>
            <tr>
                <td><?php echo t("CCDate") ?>:</td>
                <td id="paymentConfirmationExpiryDateMonth"></td>
                <td id="paymentConfirmationExpiryDateYear"></td>
        </table>
    </div>
    ...
    <a href="/Shop/<?php get_param('lang', 'de') ?>/home" class="paymentHomeLinkBtn" id="paymentHomeLinkBtn">
